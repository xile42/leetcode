...
# multiple slashes such as "//" are interpreted as a single slash. In this problem,
# treat sequences of periods not covered by the previous rules (like "...") as valid
# names for files or directories.
#
...
#
#
#  Related Topics String Stack 👍 5661 👎 1293
